...
function keymaps.setup()
	...
	wk.register({
		...
		["<Leader>"] = { "<cmd>HopLineStart<CR>", "Hop Line" },
		w = { "<cmd>HopWord<CR>", "Hop Word" },
		s = { "<cmd>HopChar1<CR>", "Hop Char" },
	}, {
	...
	wk.register({
		f = {
			...
			B = { "<cmd>Telescope current_buffer_fuzzy_find<CR>", "Telescope Buffer Search" },
